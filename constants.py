...
DAYS_WITHOUT_REPORT = [date(2020, 12, 8), date(2020, 12, 25), date(2021, 1, 1), date(2021, 1, 6), date(2021, 3, 19), date(2021, 10, 12), date(2021, 11, 1), date(2021, 11, 9), date(2021, 12, 6), date(2021, 12, 8)]
SPAIN = "España"
